...
```{r,echo=FALSE, message=FALSE}
attach(cleaned_data)
propensity_score <- glm(vaccine_coverage_over_ave ~ country+status+adult_mortality+Alcohol+total_expenditure+GDP+Schooling+BMI,
                        family = binomial,
                        data = cleaned_data)
